...
class LENET5:
    """docstring forLENET5."""
    def __init__(self, t_input, t_output, v_input, v_output, method):
    ...
    def save_parameters(self,mainPath):
        ...
        if not os.path.exists(path):
            os.makedirs(path)
        for layer in tqdm(self.layers, desc="saving layers.."):
    ...
    def load_parameters(self, **params):
        ...
        #for layer in tqdm(self.layers, desc="load layers.."):
...
def main():
    ...
    method = "rmsprop"
    epochs = 500
    mylenet = LENET5(X_train, Y_train, X_test, Y_test, method=method,)
    ...
    imgpath= "C:/Users/ASUS/Documents/softmax-test/data_kain/gringsing/gringsing_67.jpg"
